...
<body>
	...
	<!-- 'tombol' buat baru -->
	<a href="hlm_tugas.php?id_semester=<?php echo $_GET['id_semester'] ?>
							&id_matkul=<?php echo $_GET['id_matkul'] ?>
							&buat_baru" class="tombol">BUAT BARU (+)</a>
	...
	<?php if (isset($_GET['buat_baru'])): ?>
		...
		<?php endif ?>
				...
				<a href="hlm_tugas.php?id_semester=<?php echo $_GET['id_semester'] ?> 
										&id_matkul=<?php echo $_GET['id_matkul'] ?>" class="tombol">Cancel</a>
			</form>
		</div>
	<?php endif ?>
